...
constexpr double CAM_DEFOCUS_ANGLE{ 10.0 };
constexpr double CAM_FOCUS_DIST{ 3.4 };
...
int main()
{
	...
	Vec3 lookAt(0, 0, -1);
	Vec3 camVUP(0, 1, 0);
	Camera mainCamera((16.0 / 9.0), RES_WIDTH_PIXELS, pixelBuffer, USE_MT, AA_NUM_SAMPLES, MAX_RAY_BOUNCES, VERTICAL_FOV, lookF, lookAt, camVUP, CAM_DEFOCUS_ANGLE, CAM_FOCUS_DIST);
