export module indus.utilities.threadpool;

import std;

import indus.utilities.job;
...
private:
  ...
  std::vector<std::size_t> m_threadIDs{};
  ...
  void worker(std::stop_token stopToken, std::size_t threadID);
};
